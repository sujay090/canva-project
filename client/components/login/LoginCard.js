  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md mx-4 transition-all duration-300">
      <div className="text-center space-y-8">
        ...
        <Button
          variant={"outline"}
          className={`w-full flex items-center justify-center gap-3 py-6 text-gray-700 border-gray-300 hover:border-[#8b3dff] hover:text-[#8b3dff] transition-all duration-300 transform group  hover:scale-[1.01] active:scale-[0.99]`}
